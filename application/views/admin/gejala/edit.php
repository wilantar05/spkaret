			...
			<div class="row">
				...
				<div class="col-xl-12 col-md-12">
					<div class="card">
                        ...
                        <input type="hidden" name="Id_Gejala" value="<?php echo ($gejala != null) ? $gejala[0]['Id_Gejala'] : "" ?>">
						<div class="card-body border-0">
                            <div class="form-group">
								<label for="exampleFormControlInput1">Gejala</label>
								<input type="text" name="Nama_Gejala" class="form-control" id="exampleFormControlInput1" placeholder="Nama Gejala" value="<?php echo ($gejala != null) ? $gejala[0]['Nama_Gejala'] : "" ?>">
							</div>
